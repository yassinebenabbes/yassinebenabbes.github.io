...
(function () {
    const translations = {
        ...
        'pp4.desc': {
            fr: "Architecte de la <strong>plateforme MIA</strong>, plateforme IA en microservices dédiée à l'orchestration de workflows structurés, déployée en production pour des grands comptes.<br /><br />Conception de <strong>pipelines RAG</strong> et d'ingestion de documents, avec structuration de connaissances en collaboration avec les équipes data science. Mise en place de <strong>workflows IA multi-étapes</strong> orchestrés en asynchrone via Kafka. Architecture microservices avec APIs REST conçues pour des intégrations LLM (OpenAI et multi-LLM). Stack Python intensive (automation, intégrations, data extraction, glue code), déploiements AWS (EC2, S3) et on-premise. CI/CD complet via GitHub Actions et Docker. Monitoring et observabilité (Grafana) pour les services IA en production. Revue de code et accompagnement technique de l'équipe.<br /><br /><strong>Clients majeurs :</strong><br /><strong>Framatome</strong> — robustesse, traçabilité et intégration en environnement haute performance.<br /><strong>Attijariwafa Bank</strong> — services backend sécurisés, gestion des accès JWT, conformité réglementaire.<br /><strong>Picard</strong> — rétrodocumentation SI, analyse de la dette technique, cartographie des dépendances.",
            en: "Architect of the <strong>MIA platform</strong>, a microservices-based AI platform for structured workflow orchestration, deployed in production for major enterprise clients.<br /><br />Designed <strong>RAG pipelines</strong> and document ingestion layers, with knowledge structuring built in close collaboration with data science teams. Built <strong>multi-step AI workflows</strong> orchestrated asynchronously via Kafka. Microservices architecture with REST APIs designed for LLM integrations (OpenAI and multi-LLM). Python-heavy stack (automation, integrations, data extraction, glue code), deployed on AWS (EC2, S3) and on-premise. Full CI/CD with GitHub Actions and Docker. Monitoring and observability (Grafana) for production AI services. Code review and technical mentoring.<br /><br /><strong>Major client projects:</strong><br /><strong>Framatome</strong> — robustness, traceability and integration in high-performance environments.<br /><strong>Attijariwafa Bank</strong> — secure backend services, JWT-based access management, regulatory compliance.<br /><strong>Picard</strong> — IS retrodocumentation, technical debt analysis and dependency mapping."
        },
        ...
        'pp5.desc': {
            fr: "<strong>Paradoxe.ai</strong>, plateforme IA en production. Je conçois et déploie le backend qui alimente les agents LLM automatisant des workflows métier complexes.<br /><br /><strong>Orchestration d'agents LLM</strong> avec workflows multi-étapes. <strong>Intégrations MCP</strong> et patterns de <strong>tool calling</strong> pour connecter les agents aux systèmes externes (APIs tierces, bases de données, services cloud). Sécurisation des flux, stabilisation des releases et observabilité pour systèmes IA en production. Backend Python intensif (automation, intégrations, data extraction, glue code). CI/CD GitHub Actions et Docker, déploiement AWS. Monitoring, logs, alerting et suivi des performances. Revue de code et accompagnement technique de l'équipe. Transformation des retours internes en fonctionnalités livrées en continu.",
            en: "<strong>Paradoxe.ai</strong>, a production-grade AI platform. I design and ship the backend powering LLM agents that automate complex business workflows.<br /><br /><strong>LLM agent orchestration</strong> with multi-step workflows. <strong>MCP integrations</strong> and <strong>tool calling</strong> patterns to connect agents to external systems (third-party APIs, databases, cloud services). Flow security, release stabilization and observability for production AI systems. Python-heavy backend (automation, integrations, data extraction, glue code). CI/CD with GitHub Actions and Docker, AWS deployment. Monitoring, logging, alerting and performance tracking. Code review and technical mentoring across the dev team. Converting internal feedback into shippable features on a continuous release cadence."
        },
